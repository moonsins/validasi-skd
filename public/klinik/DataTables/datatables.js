 ...
 *   https://datatables.net/download/#bs4/dt-1.13.8/fh-3.4.0/sp-2.2.0
 *
 * Included libraries:
 *   DataTables 1.13.8, FixedHeader 3.4.0, SearchPanes 2.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.13.8/fh-3.4.0/sp-2.2.0",
